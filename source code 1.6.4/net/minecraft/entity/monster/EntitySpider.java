...
import _rideablespiders.EntityMobMod;
...
import _rideablespiders.gui.InventorySpider;
import _rideablespiders.proxy.Client;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class EntitySpider extends EntityMobMod
{
    ...
    public void onUpdate()
    {
        ...
        {
        	AttributeInstance attributeinstance = this.getEntityAttribute(SharedMonsterAttributes.followRange);
        	...
        	boolean flag3 = entity != null && entity instanceof EntitySpider && (!((EntitySpider) entity).isTamed() || ((EntitySpider) entity).getOwner() != this.riddenByEntity && ((EntityCreature)entity).getEntityToAttack() == this.riddenByEntity);
            ...
            if(this.riddenByEntity instanceof EntityPlayer)
            {
            	...
            	if(this.tickheal <=0)
            	{
		            ...
		            if(itemstack != null && itemstack.itemID == RideAbleSpidersMod.spiderFood.itemID && this.getMaxHealth() > this.getHealth())
		            {
		            	this.heal(1F);
		            	this.tickheal = 40;
    ...
    public void opengui(EntityPlayer player)
    {
    	if(!this.worldObj.isRemote)
    	{
    		player.openGui(RideAbleSpidersMod.instance, 0, this.worldObj, this.entityId, 0, 0);
    	}
    	else
    	{
    		this.gui = true;
...
//    	this.inventory.dropAllItems();
     ...
     */
    public static boolean isSpiderArmor(int id)
	{
		return id == RideAbleSpidersMod.armorLeather.itemID || id == RideAbleSpidersMod.armorDiamond.itemID || id == RideAbleSpidersMod.armorGold.itemID || id == RideAbleSpidersMod.armorIron.itemID;
	}
    ...
    {
    	return this.getCurrentItemOrArmor(2);
    }
   ...
   protected void damageArmor(float par1)
   {
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (this.isTamed() && !this.worldObj.isRemote && (this.riddenByEntity == null || this.riddenByEntity == par1EntityPlayer))
        {
        	...
        	{
        		if(itemstack.itemID == RideAbleSpidersMod.spiderFood.itemID)
        		{
            		this.heal(3F);
            		healed = true;
        		}
        		
        		if(itemstack.itemID == RideAbleSpidersMod.spiderGoldFood.itemID)
        		{
            		healed = true;
            		this.heal(20F);
        		}
        ...
        else if (itemstack != null && (itemstack.itemID == RideAbleSpidersMod.spiderFood.itemID ||itemstack.itemID == RideAbleSpidersMod.spiderGoldFood.itemID) && (findPlayerToAttack()  == null ||itemstack.itemID == RideAbleSpidersMod.spiderGoldFood.itemID) && !this.isTamed())
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
            ...
            if (!this.worldObj.isRemote)
            {
                if (this.rand.nextInt(3) == 0 || itemstack.itemID == RideAbleSpidersMod.spiderGoldFood.itemID)
                {
                	this.setTamed(true);
                    this.setPathToEntity((PathEntity)null);
                    this.setAttackTarget((EntityLivingBase)null);
    ...
    protected void dropFewItems(boolean par1, int par2)
    {
        ...
        if(this.isSaddled())
        {
        	this.dropItem(RideAbleSpidersMod.saddle.itemID, 1);
        } 
        if(this.isarmored())
        {
