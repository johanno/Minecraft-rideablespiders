...
public class RenderSpider extends RenderLiving
{
    ...
    protected int setSpiderEyeBrightness(EntitySpider par1EntitySpider, int par2, float par3)
    {
    	...
    	if (par2 == 1 && par1EntitySpider.isSaddled())
    	{
    		this.bindTexture(new ResourceLocation("spidermod:textures/spider_saddle.png"));
    		return 1;
    	}
    	else if(par2 == 0 && par1EntitySpider.isarmored())
    	{
    		this.bindTexture(new ResourceLocation("spidermod:textures/armor/"+((ItemArmor)par1EntitySpider.getarmor().getItem()).getArmorMaterial()+".png"));
    		return 1;
    	}
    	else if(par2 == 2)
    	{
