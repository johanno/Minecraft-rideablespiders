...
public class InventorySpider implements IInventory
{
		...
		public EntitySpider spider;
		
		public InventorySpider(EntitySpider spiderentity)
		{
	     ...
	     * Args: itemstack, flag
	     */
	    public EntityItem dropPlayerItemWithRandomChoice(ItemStack par1ItemStack, boolean par2, EntityLiving entity)
	    {
	        ...
	        else
	        {
	            ...
	            {
	                f = 0.3F;
	                entityitem.motionX = (double)(-MathHelper.sin(entity.rotationYaw / 180.0F * (float)Math.PI) * MathHelper.cos(entity.rotationPitch / 180.0F * (float)Math.PI) * f);
	                entityitem.motionZ = (double)(MathHelper.cos(entity.rotationYaw / 180.0F * (float)Math.PI) * MathHelper.cos(entity.rotationPitch / 180.0F * (float)Math.PI) * f);
	                entityitem.motionY = (double)(-MathHelper.sin(entity.rotationPitch / 180.0F * (float)Math.PI) * f + 0.1F);
	                f = 0.02F;
	    ...
	    public void damageArmor(float par1)
	    {
	        ...
	        if (this.items[1] != null && this.items[1].getItem() instanceof ItemArmor)
	        {
		...
		public boolean isItemValidForSlot(int i, ItemStack itemstack) 
		{
			if(itemstack !=null)
			{
				...
				return i == 0 ? id == RideAbleSpidersMod.saddle.itemID : this.spider.isSpiderArmor(id);
			}
			return false;
		}
}
