...
public class EntityRSpider extends EntityMobMod
{
    ...
    private static boolean isjumpingsing = false;
...
//    	this.inventory.dropAllItems();
    ...
    public void moveEntityWithHeading(float par1, float par2)
    {
    	if(this.isSaddled()&& this.riddenByEntity != null)
    	{
    		...
    		if(!br && this.onGround)
    		{
    			this.motionY = (float) (this.isjumping ? 0.55F +(Math.abs(motionX)+Math.abs(motionZ))*0.2 : 0.0F);
    			...
    			if (par2 > 0.0F)
    			{
    				...
    				this.motionX += (double)(-0.4F * f2)*(this.isjumping?this.motionY*2: 0.5F)*(this instanceof EntityRCaveSpider ? 0.5F:1);
    				this.motionZ += (double)(0.4F * f3)*(this.isjumping?this.motionY*2: 0.5F)*(this instanceof EntityRCaveSpider ? 0.5F:1);
