...
//			}
			...
			if (arg0.equals("nh"))
			{
				...
				arg2 = patchClassASM(arg0, arg2, "a", "(Ljk;)V", true);
			}
...
//				}
		...
		private void netservh(MethodNode m, boolean obf, String arg)
		{
			...
			toInject.add(l1);
			toInject.add(new VarInsnNode(ALOAD, 0));
			toInject.add(new FieldInsnNode(GETFIELD, obf?arg:"net/minecraft/network/NetHandlerPlayServer", obf?"b":"playerEntity", obf?"Lmw;":"Lnet/minecraft/entity/player/EntityPlayerMP;"));
			toInject.add(new FieldInsnNode(GETFIELD, obf?"sa":"net/minecraft/entity/Entity", obf?"m":"ridingEntity", obf?"Lsa;":"Lnet/minecraft/entity/Entity;"));
			...
			toInject.add(new VarInsnNode(ALOAD, 2));
			toInject.add(new TypeInsnNode(INSTANCEOF, "com/johanno/rideablespiders/Entity/EntityRSpider"));
			toInject.add(new JumpInsnNode(IFEQ, l2));
			toInject.add(new VarInsnNode(ALOAD, 1));
			toInject.add(new MethodInsnNode(INVOKEVIRTUAL, obf?"jk":"net/minecraft/network/play/client/C0CPacketInput", obf?"e":"func_149618_e", "()Z"));
			toInject.add(new JumpInsnNode(IFEQ, l2));
			LabelNode l3 = new LabelNode();
		    toInject.add(l3);
		    toInject.add(new VarInsnNode(ALOAD, 2));
		    toInject.add(new TypeInsnNode(CHECKCAST, "com/johanno/rideablespiders/Entity/EntityRSpider"));
		    toInject.add(new InsnNode(ICONST_1));
		    toInject.add(new MethodInsnNode(INVOKEVIRTUAL, "com/johanno/rideablespiders/Entity/EntityRSpider", "setJump", "(Z)V"));
		    toInject.add(l2);
...
//		toInject.add(new MethodInsnNode(INVOKEVIRTUAL, "java/io/PrintStream", "println", "(Ljava/lang/String;)V"));
