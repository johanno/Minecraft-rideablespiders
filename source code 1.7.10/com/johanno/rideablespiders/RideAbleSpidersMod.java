...
public class RideAbleSpidersMod 
{
    ...
    //------------Declaration-------
   // public static int entityId = EntityRegistry.findGlobalUniqueEntityId();
    ...
    public static Item armorIron = new ItemArmorSpider(ItemArmor.ArmorMaterial.IRON, 2, 2).setUnlocalizedName("armorIron");
    public static Item armorDiamond = new ItemArmorSpider(ItemArmor.ArmorMaterial.DIAMOND, 3, 3).setUnlocalizedName("armorDiamond");
